...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        gridLayout_4->addLayout(verticalLayout, 0, 1, 4, 1);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        groupBox->setTitle(QApplication::translate("Dialog", "&Primary Key", 0));
        ...
        comboBox_2->insertItems(0, QStringList()
         ...
         << QApplication::translate("Dialog", "Descending", 0)
        );
        groupBox_2->setTitle(QApplication::translate("Dialog", "&Secondary Key", 0));
        comboBox_3->clear();
        ...
        groupBox_3->setTitle(QApplication::translate("Dialog", "&Tertiary Key", 0));
