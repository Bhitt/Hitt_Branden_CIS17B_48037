...
private slots:
    ...
    void on_UnitCount19_valueChanged(int arg1);
    void on_UnitCount20_valueChanged(int arg1);
    void on_UnitCount21_valueChanged(int arg1);
    void on_UnitCount22_valueChanged(int arg1);
    void on_UnitCount23_valueChanged(int arg1);
    void on_UnitCount24_valueChanged(int arg1);
    void on_UnitCount25_valueChanged(int arg1);
    void on_UnitCount26_valueChanged(int arg1);
    void on_UnitCount27_valueChanged(int arg1);
};
