...
void ListingChild1::on_CheckoutButton_clicked()
{
    emit chkOut();
}

void ListingChild1::on_UnitCount_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart1->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount2_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart2->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount3_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart3->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount4_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart4->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount5_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart5->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount6_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart6->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount7_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart7->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount8_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart8->setStyleSheet("background-color:#bbd2f7");
    }
}

void ListingChild1::on_UnitCount9_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr){
        ui->AddToCart9->setStyleSheet("background-color:#bbd2f7");
    }
}
