    ...
    ui(new Ui::ListingChild2)
{
    ...
    //create a timer to change the isCreating bool
    annoying = new QTimer();
    connect(annoying,SIGNAL(timeout()),this,SLOT(chCr()));
    annoying->start(10);
...
//    qDebug()<<total;
    ...
    unit10=temp;
    tempS = QString::number(total, 'f',2);
    if(total < 0.1) tempS = "0.00";
    ui->Money->setText(tempS);
    //send the new unit count to mainwindow
    addCart();
    //reset the button stylesheet back
    ui->AddToCart1->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart2->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart3->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart4->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart5->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart6->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart7->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart8->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
//    qDebug()<<total;
    ...
    addCart();
    //reset the button stylesheet back
    ui->AddToCart9->setStyleSheet("background-color: rgb(191, 191, 191)");
}
...
void ListingChild2::on_UnitCount10_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart1->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount11_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart2->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount12_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart3->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount13_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart4->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount14_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart5->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount15_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart6->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount16_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart7->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount17_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart8->setStyleSheet("background-color:#bbd2f7");
}

void ListingChild2::on_UnitCount18_valueChanged(int arg1)
{
    //ignore the arg
    arg1++;
    //change the button color so they know to hit update
    if(!isCr) ui->AddToCart9->setStyleSheet("background-color:#bbd2f7");
}
