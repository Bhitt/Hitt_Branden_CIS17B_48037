...
void MainWindow::crLiP1()
{
    ...
    connect(listingchild1,SIGNAL(chkOut()),this,SLOT(crChOt()));
...
void MainWindow::crLiP2()
{
    //check if any listings are displayed
    setFal();
    //create the second listing page
    isList2 = true;
    ...
    connect(listingchild2,SIGNAL(chkOut()),this,SLOT(crChOt()));
...
void MainWindow::crLiP3()
{
    ...
    connect(listingchild3,SIGNAL(chkOut()),this,SLOT(crChOt()));

    //change borders
    this->menuBar()->setStyleSheet(tr("background-color: #a4b0c4;"));
...
void MainWindow::crChOt()
{
    //check if any listings are displayed
    setFal();
    //create the checkout page
    isCheck = true;
    checkoutchild = new CheckoutChild(ui->mdiArea);
    checkoutchild->setAttribute(Qt::WA_DeleteOnClose);
    ...
    //set the status bar
    this->statusBar()->showMessage("Checkout");
}

void MainWindow::crUsCh()
{
    qDebug()<<"created the user child";
    if(isUser) userchild->close();
    isUser = true;
    //create the user child
    userchild = new UserChild(ui->mdiArea);
    userchild->setAttribute(Qt::WA_DeleteOnClose);
    userchild->setWindowFlags(Qt::FramelessWindowHint|Qt::WindowStaysOnTopHint);
    userchild->show();
    userchild->move(0,610);
    //connection
...
void MainWindow::oneOfEach()
{
    //page one unitC count holders
    unitC1=1,unitC2=1,unitC3=1;
    unitC4=1,unitC5=1,unitC6=1;
    unitC7=1,unitC8=1,unitC9=1;
    //page two unitC count holders
    unitC10=1,unitC11=1,unitC12=1;
    unitC13=1,unitC14=1,unitC15=1;
    unitC16=1,unitC17=1,unitC18=1;
    //page three unitC count holders
    unitC19=1,unitC20=1,unitC21=1;
    unitC22=1,unitC23=1,unitC24=1;
    unitC25=1,unitC26=1,unitC27=1;
    //add total of each
    totalM = 1617.94;
    crChOt();
}
