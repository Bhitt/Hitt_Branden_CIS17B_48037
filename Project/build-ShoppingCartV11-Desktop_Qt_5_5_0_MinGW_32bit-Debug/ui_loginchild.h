...
public:
    ...
    void setupUi(QMdiSubWindow *LoginChild)
    {
        ...
        eCheck = new QLabel(LoginChild);
        eCheck->setObjectName(QStringLiteral("eCheck"));
        eCheck->setGeometry(QRect(80, 200, 261, 51));
    ...
    void retranslateUi(QMdiSubWindow *LoginChild)
    {
        ...
        nameEdit->setPlaceholderText(QApplication::translate("LoginChild", "UserName", 0));
        ...
        passEdit->setPlaceholderText(QApplication::translate("LoginChild", "PassWord1#", 0));
