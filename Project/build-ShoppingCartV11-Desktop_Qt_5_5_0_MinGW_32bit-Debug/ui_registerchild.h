...
"}"));
        ...
        showChar->setGeometry(QRect(350, 190, 111, 17));
        Warning = new QLabel(RegisterChild);
        Warning->setObjectName(QStringLiteral("Warning"));
        Warning->setGeometry(QRect(60, 220, 311, 31));
        ...
        Back->setFont(font1);
        toolButton = new QToolButton(RegisterChild);
        toolButton->setObjectName(QStringLiteral("toolButton"));
        toolButton->setGeometry(QRect(350, 150, 25, 19));
    ...
    void retranslateUi(QMdiSubWindow *RegisterChild)
    {
        ...
        nameEdit->setPlaceholderText(QApplication::translate("RegisterChild", "UserName", 0));
        ...
        passEdit->setPlaceholderText(QApplication::translate("RegisterChild", "PassWord1#", 0));
        ...
        confirmEdit->setPlaceholderText(QApplication::translate("RegisterChild", "PassWord1#", 0));
        Back->setText(QApplication::translate("RegisterChild", "Back", 0));
        toolButton->setText(QApplication::translate("RegisterChild", "...", 0));
    } // retranslateUi
